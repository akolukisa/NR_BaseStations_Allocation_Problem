...
class Environment:
    def __init__(self, config):
        ...
        self.ant_tx = config.get("antennas_tx", 16)
        self.beam_sharpness = config.get("beam_sharpness", 8)
        self.main_lobe_width_rad = config.get("main_lobe_width_rad", math.pi / max(self.K,1))
        self.beta_sll = config.get("beta_sll", 0.0)
