...
def main():
    ...
    with open(out, "w", newline="") as f:
        ...
        for u in users:
            ...
            vals = {name: total for name, total in rows}
            w.writerow([u] + [int(vals[name]/1e6) for name in ["hga","pbig","ga","max_sinr","random"]])
